  ...
  return (
    ...
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-xl rounded-full bg-blue-400/20 blur-3xl filter" />
        ...
        components={{
          heading2: ({children}) => (
            <h2 className="text-5xl md:text-7xl text-center text-balance font-medium">
              {children}
            </h2>
          )
        }}
      ...
      <div className="grid mt-16 items-center rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:py-12">
        ...
        <PrismicNextImage field={slice.primary.image} className={clsx("opacity-90 shadow-2xl lg:col-span-2 lg:pt-0 rounded-lg", 
