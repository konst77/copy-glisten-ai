 ...
 */
export interface IntegrationSliceDefaultPrimaryIconItem {
  /**
   * Icon field in *Integrations → Default → Primary → Icon*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integration.default.primary.icon[].icon
...
export interface IntegrationSliceDefaultPrimary {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integration.default.primary.icon[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  icon: prismic.GroupField<Simplify<IntegrationSliceDefaultPrimaryIconItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      IntegrationSlice,
      IntegrationSliceDefaultPrimaryIconItem,
